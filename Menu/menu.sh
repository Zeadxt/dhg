...
export iz="raw.githubusercontent.com/Zeadxt/kzl/main"

Name=$(curl -sShttps://${iz}/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://${iz}/ip | grep $MYIP | awk '{print $3}')
...
echo -w "• Name Server         = $( cat /etc/xray/nsdomain)"
