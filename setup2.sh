...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/Zeadxt/kzl/main/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
wget https://${URL}/domain.sh && chmod +x domain.sh && ./domain.sh
sleep 1
#install ssh ovpn
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://${URL}/insshws.sh && chmod +x insshws.sh && ./insshws.sh
